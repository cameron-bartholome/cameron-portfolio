...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Cameron Bartholome.</h2>;
  const three = <h3 className="big-heading">I build systems, tools, and ideas into reality.</h3>;
  const four = (
    <>
      <p>
        ...
        , focused on SL beam delivery systems for EUV advanced semiconductor manufacturing.
      </p>
    </>
  );
  const five = (
    <a
      ...
      href="mailto:cameronbartholome@gmail.com?subject=Website%20Inquiry&body=Hi%20Cameron,">
      Get in touch!
    </a>
  );
